...
# docs/results/aug_31_all/pipeline_default/, against lidar ground truth at
# /home/alien/data/yoda/aug_31/<yoda_seq>/<name>/offline/<timestamp>/traj.tum.
#
...
#
# Usage: compare_aug31_ground_truth.sh [results-root]
#   results-root: default docs/results/aug_31_all
set -uo pipefail

REPO="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
DATA_ROOT=/home/alien/data/yoda/aug_31

RESULTS_ROOT="${1:-$REPO/docs/results/aug_31_all}"
